...
import { addExamCategoryAction } from "@Reduxs/QuestionLibrary/action";
...
const ModalAddExamCategory = (props) => {
  const { nodeDetail, onClose } = props;
  ...
  const handleSubmitForm = (values) => {
    ...
    dispatch(
      addExamCategoryAction({ ...values, parent: nodeDetail?.id }, callback)
    );
  };
  return (
    <ModalWrapper
...
export default ModalAddExamCategory;
